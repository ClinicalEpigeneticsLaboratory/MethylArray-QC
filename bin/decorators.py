...
def update_and_export_plot(json_path: Path | str, height: int=600, width: int=600, font_size: int=22, template: str="ggplot2", legend_title: str="", showlegend: bool=True) -> Callable:
    """
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs) -> go.Figure:
            ...
            if not isinstance(fig, go.Figure):
                raise TypeError("The decorated function must return a Plotly Figure object.")
