...
class JsonWorkflowParamExporter {
    ...
    @param imputed_mynorm_probe_count   Number of probes in imputed mynorm

    @return formated JSON string
    */
    public static String toJSON(passed_params_map, params_map_full, workflow_metadata, nextflow_version, idat_count, imputed_mynorm_probe_count_json_path) {
